...
The data set includes 10068 single cells collected from various cortical layers.
...
Gene information (mouse_ALM_2018-06-14_genes-rows.csv)
	gene
		Gene symbol
	chromosome
